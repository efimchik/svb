DateInput = (function($) { // Localise the $ function
    ...
    DateInput.prototype = {
        build: function() {
            var monthNav = $('<div class="month_nav">' +
            ...
            var yearNav = $('<div class="year_nav">' +
        ...
        selectMonth: function(date) {
            ...
            if (!this.currentMonth || !(this.currentMonth.getFullYear() == newMonth.getFullYear() &&
                ...
                $("td").each(function(element) {
                    if ($(element).attr("date") == dateStr) {
                        $(element).addClass("today");
                    }
                    if ($(element).attr(date) == this.selectedDateString) {
        ...
        hideIfClickOutside: function(event) {
            ...
            //     this.hide();
            // };
            console.log(this.rootLayers.css("display"));
            if (!$(this.input[0]).parent(event.target)) {
                this.hide();
            };
            if (!this.checkIfInside(event)) {
                this.hide();
            }
        },

        checkIfInside: function(event) {
            var res = false;
            if (event.clientX < this.dateSelector.outerWidth()) {
                res = true;
            }
            if (event.clientY < this.dateSelector.outerHeight()) {
                res = true;
            }
        ...
        setPosition: function() {
            ...
            this.rootLayers[0].setAttribute("style", "top:" + this.input.outerHeight() + "px !important;")
