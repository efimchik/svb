...
function Flatpickr(element, config) {
    ...
    function bind() {
        ...
        if (!self.config.noCalendar) {
            ...
            self.prevYearNav.addEventListener("click", function() {
                self.currentYear -= 1;
                self.redraw();
            });
            self.nextYearNav.addEventListener("click", function() {
                self.currentYear += 1;
                self.redraw();
            });
    ...
    function buildMonthNav() {
        ...
        self.yearNav = document.createElement("div");
        self.yearNav.classList.add("flatpickr-year");

        self.prevYearNav = createElement("span", "flatpickr-prev-year");
        ...
        self.currentYearElement = createElement("span", "cur_year");
        self.currentYearElement.classList.add("flatpickr-current-year");

        self.yearNav.appendChild(self.prevYearNav);
        self.yearNav.appendChild(self.currentYearElement);
        ...
        div.classList.add("flatpickr-nav-wrap");
        div.appendChild(self.yearNav);
        div.appendChild(self.monthNav);
